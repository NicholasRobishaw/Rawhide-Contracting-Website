    ...
    <div className="bg-[#f2d7a2] max-w-sm rounded-2xl 
        ...
        <div className="px-6 py-4">
            ...
            <div className="relative h-64 overflow-hidden">
                ...
                <button
                onClick={prevImage}
                className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 text-white px-2 py-1 cursor-pointer rounded-xl"
                >
                ...
                <button
                onClick={nextImage}
                className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 text-white px-2 py-1 cursor-pointer rounded-xl"
                >
